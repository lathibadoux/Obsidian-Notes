[[#006.4.2.1 Creating vector indexes]]
	[[#006.4.2.1.1 pgvector]]
	[[#006.4.2.1.2 Creating an IVFF index]]
	[[#006.4.2.1.3 IVFF Configuration Tuning ]]
	[[#006.4.2.1.4 Testing IVFF Performance]]
	[[#006.4.2.1.5 Vector index scans with WHERE + ORDER BY]]
[[#006.4.2.2 Adding memory to AI code reviewer]]
	[[#006.4.2.2.1 GitHubPRReviewer]]
	[[#006.4.2.2.2 get_pr_number_from_env]]
	[[#006.4.2.2.3 review_code_with_ai function]]
	[[#006.4.2.2.4 should_review_file]]
	[[#006.4.2.2.5 run_review function]]
	[[#006.4.2.2.6 main function]]
[[#006.4.2.3 load_embeddings.py]]
	[[#006.4.2.3.1 load_vectors_into_supabase function]]
...
```
* The operator `<->` means "Compute the **distance** between two vectors."
