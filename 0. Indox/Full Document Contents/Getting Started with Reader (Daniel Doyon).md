...
full_title: Getting Started with Reader
category: articles
---
> [!info] Summary (generated)
> Reader is a powerful app that helps you save, highlight, and annotate many types of documents using keyboard shortcuts and mobile features. You can also use a browser extension to save and highlight web pages, and even highlight YouTube videos with synced transcripts. The app organizes your reading into a Library for saved items and a Feed for automatic content, and it keeps improving based on user feedback.
